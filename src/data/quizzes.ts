...
export const quizzes: Record<string, QuizData> = {
  ...
  "html-skeleton-quiz": {
    ...
    question:
      "Вспомни страницу спортклубов. В какой тег в скелете документа выше нужно вложить все, что было сверстано? (1 правильный ответ)",
    options: [
      "Вариант 1 — чем выше, тем скорее браузер считает содержимое страницы.",
      "Вариант 2 — у тег body, который вложен в тег <html>, должен размещаться содержимое страницы.",
      "Вариант 3 — это отдельная страница и она должна иметь свой хедер.",
    ],
    correctAnswer: 1,
    successMessage:
      "Верно! Все видимое содержимое страницы находится в теге body.",
  },
};
